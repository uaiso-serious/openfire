...
runCurlPost "http://localhost:9090/server-properties.jsp" "csrf=${CSRF}&action=save&key=adminConsole.access.allow-wildcards-in-excludes&value=true&encrypt=false"
